                        ...
                        {onglet === "commandes" && (
                            <section className="mt-4 space-y-3">
                                {commandes.length === 0 ? (
                                    ...
                                    return (
                                        <article key={commande.id} onClick={() => router.visit(`/restaurant/commandes/${commande.id}`)} className="cursor-pointer rounded-[26px] bg-white p-5 shadow-sm ring-1 ring-jse-texte/5 transition hover:-translate-y-0.5 hover:shadow-md">
